    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.context_menu_item_buy:
                ...
                return true;
            case R.id.context_menu_item_borrow:
//TODO Add function here for borrow
                onBorrow(BooksManager.findBook(getContentResolver(), holder.bookId));
                return true;
    ...
    private void onBorrow(BooksStore.Book book) {
//TODO Change function here from Buy to Borrow
        final Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(book.getDetailsUrl()));
        startActivity(intent);
    }    
